...
tree <- ggtree(tree, mrsd = "2022-03-14", as.Date = FALSE, size = 0.4, color = "#8c8fae") +
    theme_tree2() + geom_rootedge(rootedge = 0.01, size = 0.4)
tree <- tree %<+% metadata + geom_tippoint(aes(color = group2), shape = 19, size = 4, show.legend = TRUE) +
    scale_color_manual(values = c(
        ...
        "#584563",
        "#C2C2DA"
        ), na.translate = FALSE) + scale_x_ggtree(breaks = c(
            2021.6657534246576,
            2021.7479452054795,
            2021.8328767123287,
            2021.9150684931508,
