...
input_file_1 <- "AKO_More80Cov.gisaid.aln.edited.timetree.nwk"
input_file_2 <- "AKO_More80Cov.metadata.xlsx"
output_file <- "AKO_More80Cov.gisaid.aln.edited.timetree.svg"
...
ggsave(filename = output_file, dpi = 600, width = 8, height = 12, units = "in")
